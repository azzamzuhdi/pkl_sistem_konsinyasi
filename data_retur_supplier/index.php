                ...
                <section class="content">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            AND sk.jenis_keluar IN ('Rusak', 'Kadaluarsa') AND sk.status_retur = 'Belum'
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-info" data-toggle="modal"
                                                    data-target="#modal-retur<?= $row['id_keluar']; ?>">
                                                    <i class="fas fa-plus"></i> Ajukan Retur
                                                </button>
                                            </td>
                                        </tr>
                                        <!-- Modal Retur -->
                                        <div class="modal fade" id="modal-retur<?= $row['id_keluar']; ?>">
